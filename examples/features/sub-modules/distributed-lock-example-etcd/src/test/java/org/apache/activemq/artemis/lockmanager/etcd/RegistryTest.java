...
public class RegistryTest {
   ...
   @Test
   public void testETCDOnRegistry() {
      DistributedLockManagerFactory factory = Registry.getInstance().getFactory("etcd");
      assertInstanceOf(EtcdDistributedLockManagerFactory.class, factory);
   }
